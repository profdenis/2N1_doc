...
Le projet `Shapes`, dans différentes versions, sert à démontrer le dessin de différentes formes sur une image. On peut
...
Les différentes versions du projet `Shapes` illustrent l'évolution du code pour passer d'une approche procédurale à une
approche orientée objet. La version initiale, `Version 1`, utilise une classe `Shapes` avec des méthodes statiques pour
